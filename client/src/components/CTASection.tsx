    ...
    <section className="py-20 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Countdown Timer */}
          <Card className="bg-white/10 border-white/20 backdrop-blur-sm p-8 mb-12 shadow-[0_0_20px_-6px_rgba(0,0,0,0.3),0_0_0_1px_rgba(255,255,255,0.05)] rounded-2xl">
          ...
          {/* Pricing Card */}
          <Card className="bg-white text-foreground p-8 mb-8 relative overflow-hidden shadow-[0_0_20px_-6px_rgba(0,0,0,0.3),0_0_0_1px_rgba(255,255,255,0.05)] rounded-2xl">
            {/* Popular badge */}
