          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center min-h-screen">
            ...
            <div className="space-y-8 lg:space-y-10">
              ...
              <div className="relative group max-w-2xl mx-auto lg:hidden">
                <Card className="relative overflow-hidden rounded-3xl shadow-[0_8px_30px_-8px_rgba(0,0,0,0.3),0_0_0_1px_rgba(255,255,255,0.05)] border border-slate-700/50 hover-elevate">
              ...
              <div className="grid grid-cols-3 gap-4 pt-8">
                {[
                  ...
                  <Card key={index} className="bg-slate-800/50 border-slate-700 backdrop-blur-sm p-4 text-center hover-elevate shadow-[0_6px_20px_-6px_rgba(0,0,0,0.4),0_0_0_1px_rgba(255,255,255,0.05)] rounded-2xl">
