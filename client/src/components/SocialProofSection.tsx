        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-16">
            {stats.map((stat, index) => (
              <Card key={index} className="p-6 text-center hover-elevate shadow-[0_6px_20px_-6px_rgba(0,0,0,0.25),0_0_0_1px_rgba(255,255,255,0.05)] rounded-2xl">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="p-6 hover-elevate shadow-[0_6px_20px_-6px_rgba(0,0,0,0.25),0_0_0_1px_rgba(255,255,255,0.05)] rounded-2xl">
